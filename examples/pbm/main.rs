...
use gfx_hal::pso::{
    ...
    Element, EntryPoint, GraphicsShaderSet, ShaderStageFlags, VertexBufferSet, Viewport,
};
...
fn graph<'a>(viewport: Viewport, surface_format: Format, graph: &'a mut GraphBuilder<DrawPbm>) {
